...
public class RandomCube : MonoBehaviour
{
    ...
    private Vector3Int lastCubePosition;  // Переменная для хранения позиции последнего созданного куба
    ...
    //onlyForward запрещает создавать кубы по X пока не срздаст 2 куба по Z
    ...
    public void CreateRandomCube()
    {
        ...
        // Создание нового куба на новой позиции
        //GameObject newCube = Instantiate(cubePrefab[Random.Range(0, 2)], newPosition, Quaternion.identity);
